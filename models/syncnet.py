...
class SyncNet_color(nn.Module):
    def __init__(self):
        ...
        self.face_encoder = nn.Sequential(
            Conv2d(30, 32, kernel_size=(7, 7), stride=1, padding=3, act="leaky"), # 192, 384
            
            Conv2d(32, 64, kernel_size=5, stride=(1, 2), padding=1, act="leaky"), # 192, 192
            Conv2d(64, 64, kernel_size=3, stride=1, padding=1, residual=True, act="leaky"),
            Conv2d(64, 64, kernel_size=3, stride=1, padding=1, residual=True, act="leaky"),

            Conv2d(64, 128, kernel_size=3, stride=2, padding=1, act="leaky"), # 96, 96
            Conv2d(128, 128, kernel_size=3, stride=1, padding=1, residual=True, act="leaky"),
            Conv2d(128, 128, kernel_size=3, stride=1, padding=1, residual=True, act="leaky"),
            
            Conv2d(128, 256, kernel_size=3, stride=2, padding=1, act="leaky"), # 48, 48
            Conv2d(256, 256, kernel_size=3, stride=1, padding=1, residual=True, act="leaky"),
            Conv2d(256, 256, kernel_size=3, stride=1, padding=1, residual=True, act="leaky"),
    
            Conv2d(256, 512, kernel_size=3, stride=2, padding=1, act="leaky"), # 24, 24
            Conv2d(512, 512, kernel_size=3, stride=1, padding=1, residual=True, act="leaky"),
            Conv2d(512, 512, kernel_size=3, stride=1, padding=1, residual=True, act="leaky"),

            Conv2d(512, 512, kernel_size=3, stride=2, padding=1, act="leaky"), # 12, 12
            Conv2d(512, 512, kernel_size=3, stride=1, padding=1, residual=True, act="leaky"),
            Conv2d(512, 512, kernel_size=3, stride=1, padding=1, residual=True, act="leaky"),

            Conv2d(512, 1024, kernel_size=3, stride=2, padding=1, act="leaky"), # 6, 6
        ...
        self.audio_encoder = nn.Sequential(
            # Modified to handle input shape [B, 1, 80, 32]
            ...
            Conv2d(32, 64, kernel_size=3, stride=(3, 2), padding=1, act="leaky"), # Adjusted stride
            Conv2d(64, 64, kernel_size=3, stride=1, padding=1, residual=True, act="leaky"),
            Conv2d(64, 64, kernel_size=3, stride=1, padding=1, residual=True, act="leaky"),
